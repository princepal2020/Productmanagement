<%@ Page Title="" Language="C#" MasterPageFile="~/SallerPanel/SallerMaster.Master" AutoEventWireup="true" CodeBehind="OrderList.aspx.cs" Inherits="Productmanagement.SallerPanel.OrderList" %>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <asp:Button ID="btn_cancel" CssClass="btn btn-danger" OnClick="btn_cancel_Click"  runat="server" Text="Delete" />
                                </div>
                            </div>
                        </div>
                    </div>
